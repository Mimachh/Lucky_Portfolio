    ...
    dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
        ...
        <div className='w-full flex justify-between items-center lg:hidden'>
            <nav>
                ...
                <CustomLink href="/videos" title="Travaux vidéos" className='mx-4'/>
                <CustomLink href="/photoshop" title="Montages Photoshop" className='mx-4'/>
                {/* <CustomLink href="/articles" title="Articles" className='ml-4'/> */}
            </nav>
            
            <nav className='flex items-center justify-center flex-wrap'>
                <motion.a href="https://twitter.com/luckymlr" target={"_blank"}
                whileHover={{ y:-2 }}
                whileTap={{ scale:0.9 }}
                className='w-10 mr-3'
                >
        ...
        {/* NavBar Mobile */}
        {
            ...
            -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
                <nav className='flex items-center flex-col justify-center'>
                    ...
                    <CustomMobileLink href="/videos" title="Travaux vidéos" className=''toggle={handleClick}/>
                    <CustomMobileLink href="/photoshop" title="Montages Photoshop" className=''toggle={handleClick}/>
